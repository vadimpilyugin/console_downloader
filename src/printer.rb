class String
  ...
  # When printed, sets the output stream color to black
  ...
  # When printed, sets the output stream background color to black
  # @return [String] output same string with control characters
  def black_bg
    return colorize(40)
  end
  # When printed, sets the output stream background color to red
  # @return [String] output same string with control characters
  def red_bg
    return colorize(41)
  end
  # When printed, sets the output stream background color to green
  # @return [String] output same string with control characters
  def green_bg
    return colorize(42)
  end
  # When printed, sets the output stream background color to yellow
  # @return [String] output same string with control characters
  def yellow_bg
    return colorize(43)
  end
  # When printed, sets the output stream background color to white
  # @return [String] output same string with control characters
  def white_bg
    return colorize(47)
  end
  # When printed, sets the output stream background color to magenta
  # @return [String] output same string with control characters
  def magenta_bg
    return colorize(45)
  end
